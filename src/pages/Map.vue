        ...
        <div class="row">
          <div v-for="items in list2" class="col-2" :key="items.taguse_id">
            <div v-for="item in dashbord" :key="item.id">
              <div
                v-if="item.id == items.taguse_id && item.location == 'Hall'" class="col"
              >
                <icon-map
      ...
      <div class="room-103">
        <div class="col">
         <div v-for="items in list2" class="col-2" :key="items.taguse_id">
            <div v-for="item in dashbord" :key="item.id">
              <div
                v-if="item.id == items.taguse_id && item.location == 103" class="col"
              >
                <icon-map
                  :id_visitor="items.visitor_id"
                  :id="items.taguse_id"
      ...
      <div class="room-105">
        <div class="col">
          <div v-for="items in list2" class="col-2" :key="items.taguse_id">
            <div v-for="item in dashbord" :key="item.id">
              <div
                v-if="item.id == items.taguse_id && item.location == 105" class="col"
              >
                <icon-map
                  :id_visitor="items.visitor_id"
                  :id="items.taguse_id"
      ...
      <div class="room-107">
        <div class="row">
          <div v-for="items in list2" class="col-2" :key="items.taguse_id">
            <div v-for="item in dashbord" :key="item.id">
              <div
                v-if="item.id == items.taguse_id && item.location == 107" class="col"
              >
                <icon-map
                  :id_visitor="items.visitor_id"
                  :id="items.taguse_id"
      ...
      <div class="room-102">
        <div class="row">
          <div v-for="items in list2" class="col-2" :key="items.taguse_id">
            <div v-for="item in dashbord" :key="item.id">
              <div
                v-if="item.id == items.taguse_id && item.location == 102" class="col"
              >
                <icon-map
                  :id_visitor="items.visitor_id"
                  :id="items.taguse_id"
